...
def list_backups() -> List[Dict[str, Any]]:
    """List available backups (compatibility wrapper for dashboard router)."""
    return get_backup_manager().list_backups()


def verify_backup(backup_id: str) -> Dict[str, Any]:
    """Verify a backup's integrity (compatibility wrapper for dashboard router)."""
    return get_backup_manager().verify_backup_integrity(backup_id)
